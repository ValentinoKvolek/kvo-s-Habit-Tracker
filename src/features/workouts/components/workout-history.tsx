...
import { isCardioType } from "@/features/workouts/schema";
import { Route, Timer } from "lucide-react";
import { SPORT_ICONS } from "@/features/habits/constants";
import type { WorkoutLogEntry } from "@/features/workouts/queries";
import type { GymWorkoutData, CardioWorkoutData, SportType } from "@/features/workouts/schema";
...
function CardioLogCard({ log, sportType }: { log: WorkoutLogEntry; sportType: string }) {
  ...
  const Icon = SPORT_ICONS[sportType as SportType] ?? SPORT_ICONS.other;
