        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="max-w-[210px] md:max-w-[240px] pl-3 border-l border-sienna-400/60"
            >
              <p className="font-serif italic text-[11px] md:text-[12px] text-parchment-700 leading-relaxed mb-2">
                &ldquo;{quote.text}&rdquo;
              </p>
              <div className="flex items-center gap-1.5">
                <div className="h-px w-3 bg-parchment-300 flex-shrink-0" />
                <p className="font-sans text-[9px] md:text-[10px] text-parchment-400 leading-snug">
                  {quote.author}
                  {quote.source && (
